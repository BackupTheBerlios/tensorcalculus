...
// DGKTSDNSOR3.cpp: Implementierung der Klasse DGKTSDNSOR3.
//
//////////////////////////////////////////////////////////////////////

#include "DGKTSDNSOR3.hpp"
#include "BlasInterface.hpp"


DGKTSDNSOR3::DGKTSDNSOR3()
:DGKTSDDataBaseNSOR()
 {
 }
...
DKTSDIterationInfo DGKTSDNSOR3::truncate2Eps(const LongReal& eps, const DKTS& A, DKTS& X, const bool& plotInfo, const bool& useX)
 {  
    DKTS Z, a, x;
...
DKTSDIterationInfo DGKTSDNSOR3::decompose(DKTS& x, const DKTS& a, const LongReal& normA, DKTSDDataBlock& dataBlock)
 {
    DKTSDIterationInfo infoEntry;
    ...
    if(resize(x, a)==true)
     ...
     {
        throw SimpleException(IString("Warning In DKTSDIterationInfo DGKTSDNSOR3::decompose(DKTS& a, DKTS& xi, const LongReal& normA, DKTSDDataBlock& dataBlock), Error in resize !!!"));
     }
...
DKTSDIterationInfo DGKTSDNSOR3::startIteration(DKTS& x, const DKTS& a)
 {
    Timer timer;
    timer.startTiming();
    ...
    const LongInt maxSteps   = DGKTSDNSOR3::maxIterations(); 
...
DGKTSDNSOR3& DGKTSDNSOR3::computeMaxPivot (LongInt& j1, LongInt& mu1)
 {
    const LongInt d = DGKTSDNSOR3::d();
    const LongInt r = DGKTSDNSOR3::r();
...
LongReal DGKTSDNSOR3::f() const
 {     
     const LongInt r = DGKTSDNSOR3::r();
     const LongInt R = DGKTSDNSOR3::k();     
...
DGKTSDNSOR3& DGKTSDNSOR3::computeGradient(const DKTS& x, const DKTS& a)
 {
    const LongInt d = DGKTSDNSOR3::d();
    const LongInt m = DGKTSDNSOR3::m(); 
    
    const LongInt r = DGKTSDNSOR3::r(); // tRank of x
    const LongInt k = DGKTSDNSOR3::k(); // tRank of b    

    const LongReal normA2 = DGKTSDNSOR3::normA2();
...
DGKTSDNSOR3& DGKTSDNSOR3::computeAllInnerProducts(const DKTS& x, const DKTS& a)
 {
