...
// DGKTSDNSOR1.cpp: Implementierung der Klasse DGKTSDNSOR1.
//
//////////////////////////////////////////////////////////////////////

#include "DGKTSDNSOR1.hpp"
#include "BlasInterface.hpp"


DGKTSDNSOR1::DGKTSDNSOR1()
:DGKTSDDataBaseNSOR()
 {
 }
...
DKTSDIterationInfo DGKTSDNSOR1::truncate2Eps(const LongReal& eps, const DKTS& A, DKTS& X, const bool& plotInfo, const bool& useX)
 {  
    DKTS Z, a, x;
...
DKTSDIterationInfo DGKTSDNSOR1::decompose(DKTS& x, const DKTS& a, const LongReal& normA, DKTSDDataBlock& dataBlock)
 {
    DKTSDIterationInfo infoEntry;
    ...
    if(resize(x, a)==true)
     ...
     {
        throw SimpleException(IString("Warning In DKTSDIterationInfo DGKTSDNSOR1::decompose(DKTS& a, DKTS& xi, const LongReal& normA, DKTSDDataBlock& dataBlock), Error in resize !!!"));
     }
...
DKTSDIterationInfo DGKTSDNSOR1::startIteration(DKTS& x, const DKTS& a)
 {
    Timer timer;
    timer.startTiming();
    ...
    const LongInt maxSteps   = DGKTSDNSOR1::maxIterations(); 
...
DGKTSDNSOR1& DGKTSDNSOR1::computeMaxPivot (LongInt& j1, LongInt& mu1)
 {
    const LongInt d = DGKTSDNSOR1::d();
    const LongInt r = DGKTSDNSOR1::r();
...
LongReal DGKTSDNSOR1::f() const
 {     
     const LongInt r = DGKTSDNSOR1::r();
     const LongInt R = DGKTSDNSOR1::k();     
...
DGKTSDNSOR1& DGKTSDNSOR1::computeGradient(const DKTS& x, const DKTS& a)
 {
    const LongInt d = DGKTSDNSOR1::d();
    const LongInt m = DGKTSDNSOR1::m(); 
    
    const LongInt r = DGKTSDNSOR1::r(); // tRank of x
    const LongInt k = DGKTSDNSOR1::k(); // tRank of b    

    const LongReal normA2 = DGKTSDNSOR1::normA2();
...
DGKTSDNSOR1& DGKTSDNSOR1::computeAllInnerProducts(const DKTS& x, const DKTS& a)
 {
